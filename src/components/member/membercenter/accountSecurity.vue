		...
		<div class="accountSecurity_control_password_control" v-show="changeControlStyle">
			<el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="120px" class="demo-ruleForm">
				  ...
				  <el-form-item>
    				...
    				<el-button class="r" @click="resetForm('ruleForm2')">取消</el-button>
				  </el-form-item>
			</el-form>
		</div>
	</div>
...
.accountSecurity_control{
	margin-top: 39px;
	height: 774px;
}
.accountSecurity_control_password{
	margin: 0 auto;
	width: 890px;
	height: 145px;
...
.accountSecurity_control_password img{
	margin-top: 15px;
	margin-left: 25px;
}
.accountSecurity_control_password p{
	margin-top: -75px;
	margin-left: 189px;
	color:#272727;
	font-size: 20px;
}
.accountSecurity_control_password_control{
	margin: 0 auto;
	width: 340px;
	height: 300px;
}
